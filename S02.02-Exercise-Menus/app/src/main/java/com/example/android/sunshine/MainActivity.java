...
public class MainActivity extends AppCompatActivity {
    ...
    // Complete (5) Override onCreateOptionsMenu to inflate the menu for this Activity
    // Complete (6) Return true to display the menu
    ...
    // Complete (7) Override onOptionsItemSelected to handle clicks on the refresh button
