...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mRefreshErrorMessageTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRefreshErrorMessageTextView = findViewById(R.id.tv_refresh_error);
    ...
    private void showWeatherDataView(){
        mRefreshErrorMessageTextView.setVisibility(View.INVISIBLE);
    ...
    private void showErrorMessage() {
        ...
        mRefreshErrorMessageTextView.setVisibility(View.VISIBLE);
    }
